	...
	<body id="cpanel" onload="load()" >
		...
		<script type="text/javascript">
			function showNotification(message, type = 'success') {
				...
				notificationBar.classList.toggle('error', type === 'error');
				notificationBar.style.display = 'block';

				setTimeout(() => {
					notificationBar.style.display = 'none';
				}, 10000); // Notification hides after 10 seconds to accommodate longer messages
			}

			// Example Usage
			$(document).ready(function() {
				// Simulate the custom notification message
				setTimeout(() => {
					const customMessage = `
						<strong>Important Update</strong><br><br>
						Starting January 1, 2025, Trackgree will require a $5 yearly subscription per device to continue using the service.<br>
						This charge will help us maintain and improve the system, ensuring reliable service and introducing new features to enhance your experience.<br><br>
						Thank you for your understanding and support as we grow together!<br><br>
						For questions, contact us at <strong>support@trackgree.com</strong>.
					`;
