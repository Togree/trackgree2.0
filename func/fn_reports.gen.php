<?
	...
	function reportsGenerate()
	{
		...
		$report_html .= reportsGenerateLoop($type, $imeis, $dtf, $dtt, $ignore_empty_reports, $speed_limit, $stop_duration, $show_coordinates, $show_addresses, $zones_addresses, $marker_ids, $zone_ids, $sensor_names, $data_items, $other);
	...
	function reportsGenerateLoop($type, $imeis, $dtf, $dtt, $ignore_empty_reports, $speed_limit, $stop_duration, $show_coordinates, $show_addresses, $zones_addresses, $marker_ids, $zone_ids, $sensor_names, $data_items, $other)
	{
		global $la;
		...
		for ($i=0; $i<count($imeis); ++$i)
		{
			...
			else if ($type == "route_data_sensors") //ROUTE DATA WITH SENSORS
			{
				...
				$report = reportsGenerateRouteDataSensors($imei, convUserUTCTimezone($dtf), convUserUTCTimezone($dtt), $sensors_, $show_coordinates, $show_addresses, $zones_addresses, $data_items);
			...
			{
				$report = reportsGenerateMarkerInOut($imei, convUserUTCTimezone($dtf), convUserUTCTimezone($dtt), $show_coordinates, $show_addresses, $zones_addresses, $marker_ids, $data_items);
			...
			{
				$report = reportsGenerateMarkerInOutGenInfo($imei, convUserUTCTimezone($dtf), convUserUTCTimezone($dtt), $speed_limit, $stop_duration, $show_coordinates, $show_addresses, $zones_addresses, $marker_ids, $data_items);
	...
	function reportsGenerateRouteDataSensors($imei, $dtf, $dtt, $sensors, $show_coordinates, $show_addresses, $zones_addresses, $data_items)	
	{
		global $ms, $_SESSION, $gsValues, $la;
	...
	function reportsGenerateMarkerInOut($imei, $dtf, $dtt, $show_coordinates, $show_addresses, $zones_addresses, $marker_ids, $data_items) //MARKER_IN_OUT
	{
		global $ms, $_SESSION, $la, $user_id;
		...
		for ($i=0; $i<count($in_markers); ++$i)
		{
			...
			if (in_array("marker_position", $data_items))
			{
				$result .= '<td>'.reportsGetPossition($in_markers[$i][6], $in_markers[$i][7], $show_coordinates, $show_addresses, $zones_addresses).'</td>';
			}
	...
	function reportsGenerateMarkerInOutGenInfo($imei, $dtf, $dtt, $speed_limit, $stop_duration, $show_coordinates, $show_addresses, $zones_addresses, $marker_ids, $data_items) //MARKER_IN_OUT_WITH_GEN_INFO
	{
		global $ms, $_SESSION, $la, $user_id;
	...
	function reportsGenerateZoneInOut($imei, $dtf, $dtt, $show_coordinates, $show_addresses, $zones_addresses, $zone_ids, $data_items) //ZONE_IN_OUT
	{
		...
		for ($i=0; $i<count($in_zones); ++$i)
		{
			...
			if (in_array("zone_position", $data_items))
			{
				$result .= '<td>'.reportsGetPossition($in_zones[$i][6], $in_zones[$i][7], $show_coordinates, $show_addresses, $zones_addresses).'</td>';
			}
	...
	function reportsGenerateZoneInOutGenInfo($imei, $dtf, $dtt, $speed_limit, $stop_duration, $show_coordinates, $show_addresses, $zones_addresses, $zone_ids, $data_items) //ZONE_IN_OUT_WITH_GEN_INFO
	{
		global $ms, $_SESSION, $la, $user_id;
